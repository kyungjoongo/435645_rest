...
router.get('/fightcard_detail2/:title', function (req, _response, next) {
    ...
    $('.fight').each(function () {
        ...
        var fighter_names1 = ''
        var extract_fighter_name1 = ''
        var fighter_names2 = ''
        var extract_fighter_name2 = ''

        if (fighter_image1 != undefined && fighter_image1 != '') {

            fighter_names1 = fighter_image1.split("/")
            extract_fighter_name1 = fighter_names1[5];
            fighter_names2 = fighter_image2.split("/")
            extract_fighter_name2 = fighter_names2[5];
